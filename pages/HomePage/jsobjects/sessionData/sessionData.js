export default {
 ...
 distrettiByKeyword: {
    "messina" : this.distretti[1],
    "taormina": this.distretti[3],
    "milazzo": this.distretti[4],
    "lipari": this.distretti[5],
    "barcellona": this.distretti[6],
    "patti": this.distretti[7],
    "mistretta": this.distretti[8],
    "agata": this.distretti[9]
},
...
listaPrestazioniVolumi: ["897","8901","8913","9502","8926","87371","87372","8741","88011","88012","88013","88014","88015","88016",
    ...
    "9511","93081"],
	initSessionData() {
		storeValue("MESSINA_DISTRETTI",this.distretti);
		storeValue("MESSINA_DISTRETTI_BY_KEYWORD",this.distrettiByKeyword);
		storeValue("MESSINA_RECAPITI_DISTRETTI", this.recapitiDistretti);
		storeValue("MESSINA_COMUNI_DISTRETTI",this.comuniDistretti);
		storeValue("MESSINA_LISTA_PRESTAZIONI_VOLUMI", this.listaPrestazioniVolumi)
		storeValue("DISTRETTO_CORRENTE",1);
		storeValue("USER_ID","roberto.dedomenico");
		storeValue("VERSION","0.1beta")
	},
}